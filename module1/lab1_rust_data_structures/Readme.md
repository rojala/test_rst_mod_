...
## Can you modify the program to create an instance of each of these collections and perform some basic operations on them (like inserting and removing elements)?
See patches
